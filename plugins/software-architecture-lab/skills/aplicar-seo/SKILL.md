---
name: aplicar-seo
description: Audita e aplica SEO profissional no Software Architecture Lab. Use quando o usuário pedir para revisar, melhorar, validar ou preparar o SEO de trilhas, conceitos, páginas estáticas ou do site como um todo.
---
...
- Ao preparar o site para indexação ou lançamento
...
1. `tags` no frontmatter: use 4–8 tags descritivas
...
- Importar `SITE_NAME` ou `SITE_URL` no layout já importa do `seo.ts`; não defina variáveis locais duplicadas
