...
<OrbitDiagram
  title="Camadas do Frontend — Diagrama Orbital"
  centerLabel="Feature / Domínio"
  centerColor="#00b8d9"
  layers={[
    { label: "Camada de Serviço", color: "#3ecf8e", items: ["fetchUser", "updateOrder", "getProducts"] },
    { label: "Camada de Lógica (Hooks)", color: "#9b6fff", items: ["useUser", "useOrders", "useCart"] },
    { label: "Camada de UI (Componentes)", color: "#00b8d9", items: ["UserProfile", "OrderList", "CartButton"] },
  ]}
/>
